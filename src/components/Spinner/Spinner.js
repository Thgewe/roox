const Spinner = () => {
  ...
  <defs>
    ...
    <path id="ldio-jm1x3ybj9g-p2" d="M0 52L58 52L64 47L100 47L100 90L0 90Z"></path>
    <clipPath id="ldio-jm1x3ybj9g-cp1"><use xlinkHref="#ldio-jm1x3ybj9g-p1"></use></clipPath>
    <clipPath id="ldio-jm1x3ybj9g-cp2"><use xlinkHref="#ldio-jm1x3ybj9g-p2"></use></clipPath>
  </defs>
  <g clipPath="url(#ldio-jm1x3ybj9g-cp2)"><path fill="#77a4bd" d="M26.1 61.7l1.6-4.3c0.4-1.1-0.1-2.3-1.2-2.8c-1.1-0.4-2.3 0.1-2.8 1.2l-1.6 4.3 c-0.4 1.1 0.1 2.3 1.2 2.8c0.3 0.1 0.5 0.1 0.8 0.1C24.9 63.1 25.8 62.6 26.1 61.7z">
  ...
  <path fill="#77a4bd" d="M58.3 63.1l2.1-5.5c0.4-1.1-0.1-2.3-1.2-2.8c-1.1-0.4-2.3 0.1-2.8 1.2l-2.1 5.5 c-0.4 1.1 0.1 2.3 1.2 2.8c0.3 0.1 0.5 0.1 0.8 0.1C57.1 64.5 57.9 63.9 58.3 63.1z">
    <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1" repeatCount="indefinite" begin="-0.30000000000000004s"></animateTransform>
  </path>
  ...
  <path fill="#77a4bd" d="M16.9 86.4l6.4-17.3c0.4-1.1-0.2-2.3-1.3-2.8c-1.1-0.4-2.3 0.2-2.8 1.3l-6.4 17.3 c-0.4 1.1 0.2 2.3 1.3 2.8c0.2 0.1 0.5 0.1 0.7 0.1C15.7 87.8 16.6 87.2 16.9 86.4z">
    <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1" repeatCount="indefinite" begin="-0.6000000000000001s"></animateTransform>
  </path>
  <path fill="#77a4bd" d="M27.6 86.4l3.8-9.8c0.4-1.1-0.1-2.3-1.2-2.8c-1.1-0.4-2.3 0.1-2.8 1.2l-3.8 9.8 c-0.4 1.1 0.1 2.3 1.2 2.8c0.3 0.1 0.5 0.1 0.8 0.1C26.5 87.8 27.3 87.3 27.6 86.4z">
    <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1" repeatCount="indefinite" begin="-0.7000000000000001s"></animateTransform>
  </path>
  ...
  <path fill="#77a4bd" d="M27.6 86.4l3.8-9.8c0.4-1.1-0.1-2.3-1.2-2.8c-1.1-0.4-2.3 0.1-2.8 1.2l-3.8 9.8 c-0.4 1.1 0.1 2.3 1.2 2.8c0.3 0.1 0.5 0.1 0.8 0.1C26.5 87.8 27.3 87.3 27.6 86.4z">
    <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1" repeatCount="indefinite" begin="-1.2000000000000002s"></animateTransform>
  </path>
  <path fill="#77a4bd" d="M38.5 86.4l1-2.7c0.4-1.1-0.1-2.3-1.2-2.8c-1.1-0.4-2.3 0.1-2.8 1.2l-1 2.7 c-0.4 1.1 0.1 2.3 1.2 2.8c0.3 0.1 0.5 0.1 0.8 0.1C37.4 87.8 38.2 87.3 38.5 86.4z">
  ...
  <g clipPath="url(#ldio-jm1x3ybj9g-cp1)">
